...
const HeadSection = () => {
  return (
    <div className='w-11/12 md:w-5/6 mx-auto mt-8 md:mt-[102px] text-[48px] text-[#2C384A] font-normal text-center'>
      <div>Best Website builders in the US</div>

      <hr className='text-[#E1E4E6] my-4' />

      <div className='flex text-[10px] md:text-[14px] justify-between'>
      ...
      <div className='text-[10px] md:text-[13px] mt-8'>
        <ul className='flex text-[#4B5665] space-x-2 items-center md:space-x-28'>
          <li>Tools</li>
          <li>AWS Builder</li>
          <li>Start Build</li>
      ...
      <div className='text-[10px] md:text-[13px] flex my-8 text-[#727D87]'>
